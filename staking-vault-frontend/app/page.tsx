      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center space-y-8">
          ...
          <div className="flex justify-center">
            <div className="w-32 h-32 bg-gradient-to-br from-purple-500 to-pink-500 rounded-3xl flex items-center justify-center shadow-2xl shadow-purple-500/50">
          ...
          <div className="flex justify-center gap-4 pt-8">
            {isConnected ? (
              ...
              <div className="px-8 py-4 bg-gradient-to-r from-purple-500 to-pink-500 text-white font-semibold rounded-xl shadow-lg text-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-24">
          ...
          <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/10 hover:border-purple-500/50 transition">
            ...
            <h3 className="text-xl font-bold text-white mb-3">Secure & Audited</h3>
          ...
          <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/10 hover:border-purple-500/50 transition">
            ...
            <h3 className="text-xl font-bold text-white mb-3">Fast & Easy</h3>
            <p className="text-gray-400">
        ...
        <div className="mt-24 bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/10">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            <div>
              ...
              <p className="text-gray-400 mt-2">Active Staking</p>
            </div>
            <div>
              <p className="text-4xl font-bold text-green-400">Instant</p>
              <p className="text-gray-400 mt-2">Reward Claims</p>
            </div>
            <div>
              <p className="text-4xl font-bold text-blue-400">0%</p>
              <p className="text-gray-400 mt-2">Platform Fees</p>
            </div>
            <div>
